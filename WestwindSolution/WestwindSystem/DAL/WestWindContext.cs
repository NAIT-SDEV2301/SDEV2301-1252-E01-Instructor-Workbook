...
public partial class WestWindContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BuildVer__3214EC07E14B753F");
        ...
        {
            entity.Property(e => e.Active).HasDefaultValue(true, "DF_Employees__Active");
        ...
        {
            entity.HasKey(e => e.ManifestItemID).HasName("PK__Manifest__9000192CFA43A7C1");
        ...
        modelBuilder.Entity<Payment>(entity =>
        {
            ...
            entity.Property(e => e.PaymentDate).HasDefaultValueSql("(getdate())", "DF_PAY_PDate_Today");
        ...
        {
            entity.HasKey(e => e.ShipmentID).HasName("PK__Shipment__5CAD378D96988AB9");
